...
is( "$l1",
    qq{<svg height="10" viewBox="0 -6.67 33 10" width="33" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" points="$points" stroke="#000" stroke-width="1" /></svg>},
...
is( "$l2",
    qq{<svg height="10" viewBox="0 -6.67 33 10" width="33" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" points="$points" stroke="#000" stroke-width="0.5" /></svg>},
    'thickness changed: output correct'
);

my $l3 = SVG::Sparkline->new( Line => { -nodecl=>1, values=>\@yvalues, color=>'#888', width=>33 } );
is( "$l3",
    qq{<svg height="10" viewBox="0 -6.67 33 10" width="33" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" points="$points" stroke="#888" stroke-width="1" /></svg>},
...
is( "$l5",
    qq{<svg height="10" viewBox="0 -6.67 11 10" width="11" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" points="$points" stroke="#000" stroke-width="1" /></svg>},
    'width & 11 points: output correct'
);
