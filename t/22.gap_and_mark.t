...

{
    ...
    is( "$b",
        '<svg height="12" viewBox="0 -6 20 12" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M0.5,0v-2.5h3v2.5h1v-5h3v5h1h3h1v5h3v-5h1v2.5h3v-2.5z" fill="#000" stroke="none" /><rect fill="blue" height="5" stroke="none" width="3" x="4.5" y="-5" /></svg>',
        'Bar: gap of 1'
    );
}

{
    ...
    is( "$b",
        '<svg height="12" viewBox="0 -6 25 12" width="25" xmlns="http://www.w3.org/2000/svg"><path d="M1,0v-2.5h3v2.5h2v-5h3v5h2h3h2v5h3v-5h2v2.5h3v-2.5z" fill="#000" stroke="none" /><rect fill="blue" height="5" stroke="none" width="3" x="6" y="-5" /></svg>',
        'Bar: gap of 2'
    );
}
