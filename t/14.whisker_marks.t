...

{
    ...
    my $w = SVG::Sparkline->new( Whisker => { -nodecl=>1, values=>$values, mark=>[4=>'red'] } );
...

{
    ...
    my $w = SVG::Sparkline->new( Whisker => { -nodecl=>1, values=>$values, mark=>[3=>'green'] } );
...

{
    ...
    my $w = SVG::Sparkline->new( Whisker => { -nodecl=>1, values=>$values, mark=>[2=>'green', 4=>'red'] } );
