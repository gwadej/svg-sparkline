...
is( "$a1",
    qq{<svg height="10" viewBox="0 -6.67 33 10" width="33" xmlns="http://www.w3.org/2000/svg"><polygon fill="#000" points="$points" stroke="none" /></svg>},
...
is( "$a2",
    qq{<svg height="10" viewBox="0 -6.67 33 10" width="33" xmlns="http://www.w3.org/2000/svg"><polygon fill="#888" points="$points" stroke="none" /></svg>},
...
is( "$a5",
    qq{<svg height="10" viewBox="0 -6.67 11 10" width="11" xmlns="http://www.w3.org/2000/svg"><polygon fill="#000" points="$points" stroke="none" /></svg>},
