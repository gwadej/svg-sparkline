...
my $points = '0,-2 2,-3 4,-1 6,-5 8,0 8,-6 6,-10 4,-3 2,-6 0,-4';
{
    ...
    my $rb = SVG::Sparkline->new( RangeArea => { -nodecl=>1, values=>\@values, mark=>[2=>'blue'] } );
    is( "$rb",
...

{
    ...
    my $rb = SVG::Sparkline->new( RangeArea => { -nodecl=>1, values=>\@values, mark=>[first=>'blue'] } );
    is( "$rb",
        qq[<svg height="12" viewBox="0 -11 9 12" width="9" xmlns="http://www.w3.org/2000/svg"><polygon fill="#000" points="$points" stroke="none" />$mark</svg>],
        'first mark'
    );
...

{
    ...
    my $rb = SVG::Sparkline->new( RangeArea => { -nodecl=>1, values=>\@values, mark=>[last=>'blue'] } );
    is( "$rb",
        qq[<svg height="12" viewBox="0 -11 9 12" width="9" xmlns="http://www.w3.org/2000/svg"><polygon fill="#000" points="$points" stroke="none" />$mark</svg>],
        'last mark'
    );
...

{
    ...
    my $rb = SVG::Sparkline->new( RangeArea => { -nodecl=>1, values=>\@values, mark=>[high=>'green'] } );
    is( "$rb",
        qq[<svg height="12" viewBox="0 -11 9 12" width="9" xmlns="http://www.w3.org/2000/svg"><polygon fill="#000" points="$points" stroke="none" />$mark</svg>],
        'high mark'
    );
...

{
    ...
    my $rb = SVG::Sparkline->new( RangeArea => { -nodecl=>1, values=>\@values, mark=>[low=>'red'] } );
    is( "$rb",
        qq[<svg height="12" viewBox="0 -11 9 12" width="9" xmlns="http://www.w3.org/2000/svg"><polygon fill="#000" points="$points" stroke="none" />$mark</svg>],
        'low mark'
    );
...
eval {
    ...
    SVG::Sparkline->new( RangeArea => { -nodecl=>1, values=>\@values, mark=>[xyzzy=>'green'] } );
};
