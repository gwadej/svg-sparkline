...
is( "$w",
    '<svg height="12" viewBox="-5 -6 28 12" width="28" xmlns="http://www.w3.org/2000/svg"><path d="M1,0v-5m3,5v-5m3,5m3,0v-5m3,5m3,0v-5" stroke="#000" stroke-width="1" /></svg>',
...
is( "$wb",
     '<svg height="12" viewBox="-5 -6 28 12" width="28" xmlns="http://www.w3.org/2000/svg"><rect fill="#fff" height="14" stroke="none" width="30" x="-6" y="-7" /><path d="M1,0v-5m3,5v-5m3,5m3,0v-5m3,5m3,0v-5" stroke="#000" stroke-width="1" /></svg>',
